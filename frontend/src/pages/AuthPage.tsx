...
import { Train, Shield, Users, ArrowRight, Loader2, AlertCircle } from "lucide-react";
...
export default function AuthPage() {
  ...
  useEffect(() => {
    ...
    const handlePostLogin = async () => {
      ...
      try {
        ...
        let profile = queryClient.getQueryData<{ fullName: string }>(["registerOrLoginProfile"]);
  ...
  const isLoading = isLoggingIn || (isAuthenticated && (actorFetching || isRedirecting));
