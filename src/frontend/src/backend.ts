...
import type { Profile as _Profile, SearchFilters as _SearchFilters, Time as _Time, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async registerOrLogin(): Promise<Profile> {
        if (this.processError) {
            try {
    ...
    async searchProfiles(arg0: SearchFilters): Promise<Array<Profile>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchProfiles(to_candid_SearchFilters_n12(this._uploadFile, this._downloadFile, arg0));
                return from_candid_vec_n9(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateProfile(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: string, arg7: boolean, arg8: string | null, arg9: string | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProfile(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, to_candid_opt_n14(this._uploadFile, this._downloadFile, arg8), to_candid_opt_n14(this._uploadFile, this._downloadFile, arg9));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        desiredPostingLocation: value.desiredPostingLocation,
        userId: value.userId,
        ...
        railwayZone: value.railwayZone,
        currentPostingLocation: value.currentPostingLocation,
        contactVisible: value.contactVisible
    };
}
...
function to_candid_SearchFilters_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: SearchFilters): _SearchFilters {
